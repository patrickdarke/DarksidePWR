...
// unit-id mapping, so the unit is NOT the VRM instance number. List length
// is free including {} = none (same rule as GX_TEMP_UNITS/GX_TANK_UNITS —
// polling, control-page rows, and telemetry resize to match). One MPPT on
// this system (found by sweep; the VE.Can MPPT answers there).
#ifndef GX_SOLAR_UNITS
#define GX_SOLAR_UNITS {1}
#endif
#ifndef GX_SOLAR_LABELS
#define GX_SOLAR_LABELS {"SOLAR"}
#endif
